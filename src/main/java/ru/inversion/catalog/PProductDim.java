...
/**
@author  admin
@since   2025/06/16 14:39:36
*/
@Entity (name="ru.inversion.catalog.PProductDim")
@NamedNativeQuery (name = "ru.inversion.catalog.PProductDim", query="select p.product_id, p.product_name, p.price, p.stock_quantity, c.category_name, s.first_name, s.last_name, s.phone, s.mail  from product_dim p\n" +
"join category_dim c on p.category=c.category_dim_id\n" +
"join suppliers_dim s on p.supplier=s.id")
public class PProductDim implements Serializable
{
    private static final long serialVersionUID = 16_06_2025_14_39_36l;
